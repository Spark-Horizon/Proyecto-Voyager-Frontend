              ...
              <form onSubmit={handleSignUp}>
                {step === 1 && (
                  <div>
                    <div className="text-center mb-4">
                      ...
                      <p className="lead">Selecciona si eres profesor o estudiante</p>
                    </div>
                ...
                {step === 2 && (
                  <div>
                    <div className="text-center mb-4">
                      <h1 className="h3 mb-0">Registro</h1>
                      <p className="lead">Ingresa tu correo electrónico</p>
                    </div>
                    <div className="form-group mb-4">
                      <label htmlFor="email" className="text-center fs-4">Correo electrónico</label>
                      <input type="email" id="email" value={email} onChange={(e) => setEmail(e.target.value)} className="form-control" placeholder="Correo electrónico" required />
                      {!isEmailValid() && (
                    ...
                    <div className="d-flex justify-content-center mb-4">
                      ...
                      <button type="button" className="btn btn-primary" onClick={handleNextStep} disabled={!isEmailValid()}>Siguiente</button>
                    </div>
                  </div>
                )}
                {step === 3 && (
