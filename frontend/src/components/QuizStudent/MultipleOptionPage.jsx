...
const dummySubmitFunc = ({ respuesta, correcto }) => {
  console.log(`Respuesta: ${respuesta}, Correcto: ${correcto}`);
};

const dummyHandleNext = () => {
  console.log('Función Siguiente ejecutada.');
};

export const MultipleOptionPage = () => {
    const data = dummyData;
    const submitFunc = dummySubmitFunc;
    const handleNext = dummyHandleNext;
